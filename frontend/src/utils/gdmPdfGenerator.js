...
const buildCewbPage = (gdm, forcePageBreakAtEnd) => {
  ...
  gcChunks.forEach((chunk, chunkIndex) => {
    ...
    const itemRows = [
      [
        { text: 'S.No.', fontSize: 9, bold: true, alignment: 'center', margin: [0, 4, 0, 4] },
        { text: 'E-WayBill No. & Date', fontSize: 9, bold: true, margin: [0, 4, 0, 4] },
        { text: 'E-WayBill By', fontSize: 9, bold: true, margin: [0, 4, 0, 4] },
        { text: 'Document No. & Date', fontSize: 9, bold: true, margin: [0, 4, 0, 4] },
        { text: 'Value', fontSize: 9, bold: true, alignment: 'right', margin: [0, 4, 0, 4] },
        { text: 'To', fontSize: 9, bold: true, margin: [0, 4, 0, 4] },
        { text: 'Valid Till Date', fontSize: 9, bold: true, margin: [0, 4, 0, 4] }
      ]
    ];
    ...
    chunk.forEach((gc, i) => {
      ...
      itemRows.push([
        ...
        { text: `${ewbNo}\n${ewbDate}`, fontSize: 8, margin: [0, 4, 0, 4] },
        ...
        columns: [
          {
            ...
            table: {
              widths: ['40%', '60%'],
              body: [
                [{ text: 'Consolidated E-Way Bill No', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: gdm.cewbNumber || 'PENDING', fontSize: 9, bold: true, margin: [4, 4, 4, 4] }],
                [{ text: 'Date', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: formattedDate, fontSize: 9, bold: true, margin: [4, 4, 4, 4] }],
                [{ text: 'Generated By', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: transporterGstin, fontSize: 9, bold: true, margin: [4, 4, 4, 4] }],
                [{ text: 'Transporter ID', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: transporterGstin, fontSize: 9, bold: true, margin: [4, 4, 4, 4] }],
                [{ text: 'Vehicle No', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: gdm.vehicle?.vehicleNumber || gdm.vehicleNumber || '-', fontSize: 9, bold: true, margin: [4, 4, 4, 4] }],
                [{ text: 'From', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: 'SIVAKASI-TAMIL NADU', fontSize: 9, bold: true, margin: [4, 4, 4, 4] }],
                [{ text: 'Mode', fontSize: 9, fillColor: '#f9fafb', margin: [4, 4, 4, 4] }, { text: 'Road', fontSize: 9, bold: true, margin: [4, 4, 4, 4] }]
              ]
            },
            layout: {
              hLineWidth: function (i, node) { return 1; },
