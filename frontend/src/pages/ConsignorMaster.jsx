      ...
      <GlassCard>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
          ...
          <div className="flex items-end gap-2">
            ...
            <button type="button" onClick={handleVerifyGST} disabled={loading} className="h-9 px-3 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded-lg font-bold text-xs transition-colors border border-indigo-200 whitespace-nowrap">Verify</button>
          </div>
        ...
        <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-slate-100">
          ...
          <button onClick={handleSave} disabled={loading} className="h-9 px-5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold text-xs transition-colors flex items-center gap-2 disabled:opacity-70">
            <Save size={14} /> {formData.id ? 'Update Consignor' : 'Save Consignor'}
          </button>
        </div>
      </GlassCard>
